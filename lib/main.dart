          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 15,),
                SingleChildScrollView(padding: EdgeInsets.only(bottom: 20),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(" 250 Raating", style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 10
                                ),)
                              ],
                            ...
                            SizedBox(height: 10),
                            Text("Lorem ipsum is dummy text use for printing",
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 13
                              )
                ...
                SizedBox(height: 20),
                placesWidget("hotel2","HHHH Den"),
                SizedBox(height: 20),
                placesWidget("hotel3","Good Hotel"),
              ],
            ),
          ),
        )
